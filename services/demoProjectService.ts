...
export const createProductionDemoProject = (): ProjectState => {
  ...
  return {
    ...
    shotGenerationModel: 'shopaikey-grok-fast',
    scriptData: { ...structuredClone(MOCK_SCRIPT), targetDuration: '30s', language: 'Vietnamese', visualStyle: 'live-action cinematic neon noir', shotGenerationModel: 'shopaikey-grok-fast' },
    shots,
